...
public class MultithreadingFindNewAddSequence implements Callable<String> {
    String matchfile;
    int insertsize_avg;
    String fasta;
    String unmatchfq1;
    ...
    public MultithreadingFindNewAddSequence(PositionUnit pu, String matchfile, int insertsize_avg, String fasta, String unmatchfq1, String unmatchfq2) {
...
final class comparesm implements Comparator<SamUnit> {
    ...
    public int compare(SamUnit o1, SamUnit o2) {
        ...
        int pianyi2 = 0;
        if (matcher1.find()) {
            pianyi1 = Integer.parseInt(matcher1.group(1));
        }
        Matcher matcher2 = patternms.matcher(o2.cigar);
        if (matcher2.find()) {
            pianyi2 = Integer.parseInt(matcher2.group(1));
        }
...
final class comparemim implements Comparator<SamUnit> {
    ...
    @Override
    public int compare(SamUnit o1, SamUnit o2) {
        int q1 = Integer.parseInt(o1.mapq);
        int q2 = Integer.parseInt(o2.mapq);
        if (q1 < q2) return 1;
